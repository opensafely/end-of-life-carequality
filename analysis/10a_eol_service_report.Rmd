...
5. A&E visits
6. Attended outpatient appointments
...
## 6. Attended outpatient appoitnments

Draft text...

### Place of death 

_Figure 3: Average number of OP attendances per person by month and place of death_
```{r fig2, fig.height=1, fig.width=2, fig.cap=""}
knitr::include_graphics(here::here("output", "os_reports", "eol_service", "op_month_plot.png"))
```
