...
```{r table4}
knitr::kable(read_csv(here::here("output", "os_reports", "eol_service", "eol_count_place.csv")))
...
```{r table5}
knitr::kable(read_csv(here::here("output", "os_reports", "eol_service", "eol_count_cause.csv")))
