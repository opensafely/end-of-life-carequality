...
7. Elective admissions
    + Number of people with at least one elective admission by place of death
    + Number of people with at least one elective admission by cause of death
    + Place of death
    + Cause of death
8. Emergency admissions
    + Number of people with at least one emergency admission by place of death
    + Number of people with at least one emergency admission by cause of death
    + Place of death
    + Cause of death
...
People who died at home during the pandemic had more outpatient appointments overall, however, this will reflect changes in who was dying at home. Deaths from cancer increased at the start of the pandemic for example. For some causes of death like circulatory diseases the number of outpatient appointments decreased. _Table 2_ and _Table 3_ show the number of people who had at least one outpatient appointment in the last month of life by month, by place of death and cause od death. _Figure 8_ and _Figure 9_ highlight these and subsequent trends.

### Place of death 

_Table 2: Number of people with at least one outpatient appointment in the last month of life by month and place of death_
```{r table2}
...
_Table 3: Number of people with at least one outpatient appointment in the last month of life by month and cause of death_
```{r table3}
...
_Table 5: Number of people with at least one elective admission in the last month of life by month and cause of death_
```{r table5}
...
```
Emergency admissions towards the end of life are often not the best care for patients. _Table 6_ and _Table 7_ show the number of people who had at least one emergency admission in the last month of life by month by place of death and cause of death. We previously reported that over the last three months of life, average emergency admissions per person during the pandemic were similar to pre-pandemic levels. _Figure 12_ and _Figure 13_ show this trend and how things have changed in the intervening period. In the most recent month (`r emadm_month %>% select(study_month) %>% slice(1) %>% pull`) there were an average of `r emadm_month %>% select(mean) %>% slice(1) %>% pull` emergency admissions for patients who died at home recorded in OpenSAFELY-TPP.

### Place of death

_Table 6: Number of people with at least one emergency admission in the last month of life by month and place of death_
```{r table6}
...
_Table 7: Number of people with at least one emergency admission in the last month of life by month and cause of death_
```{r table7}
