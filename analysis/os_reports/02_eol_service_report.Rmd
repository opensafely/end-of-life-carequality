...
_Table 2: Number of people with at least one elective admission in the last month of life by month and place of death_
```{r table2}
knitr::kable(read_csv(here::here("output", "os_reports", "eol_service", "eladm_count_place.csv")))

```

_Table 3: Number of people with at least one elective admission in the last month of life by month and cause of death_
```{r table3}
