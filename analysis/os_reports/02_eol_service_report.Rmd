...
The number of people dying at home was increasing before the Covid-19 pandemic, but the pandemic accelerate this trend. People were less likely than previously to die in other settings either because they or their loved ones chose to stay at home or because the availability and access to care elsewhere had been affected. This trend of increased deaths at home has continued to the present day.  

The access people approaching the end of life have to services and the factors that influence this has changed since the start of the pandemic. For example, during the early months of the pandemic the majority of elective hospital services were shut down. These services are running again but they are under strain due to the volumes of people requiring access. 
...
General practice interactions covers information drawn from the appointments table. It represents appointments with GP's but also other other healthcare professionals from the GP practice such as nurses. There is no differentiation between face to face or other types of consultation.
...
General practice interactions increased overall but the change varied by cause of death and people who died from cancer had many more interactions with general practice than people who died from other causes. _Figure 3_ shows the changes in these trends over time.
...
In our previous work we reported that the proportion of people who died at home with medications for symptom management that general practice prescribed in the last month of life increased in the pandemic, which may have reflected changes in anticipatory prescribing to ensure that medications were available to patients when needed. _Figure 2_ and _Figure 3_ show how things have changed subsequently.
...
There was an increase in the use of Accident and Emergency (A&E) during the pandemic for people who died at home, particularly for people who died from dementia and Alzheimer's disease. _Figure 5_ and _Figure 6_ shows this trend, variation by place of death, cause of death and how things have changed since February 2021.
...
People who died at home during the pandemic had more outpatient appointments overall, however, this will reflect changes in who was dying at home with more deaths from Cancer. For some cause of death like circulatory diseases the number of outpatient appointments decreased. _Figure 7_ and _Figure 8_ highlight these trends.

### Place of death 

_Figure 7: Average number of outpatient appointments in the last month of life by month and place of death_
...
_Figure 8: Average number of outpatient appointments in the last month of life by month and cause of death_
...
People who died at home were less likely to have planned hospital admissions during the pandemic. This reflected reductions in planned care across the board, as the NHS focused on responding to Covid-19. _Figure 9_ and _Figure 10_ show this trend and how things have changed since February 2021.

### Place of death

_Figure 9: Average number of elective admissions in the last month of life by month and place of death_
...
_Figure 10: Average number of elective admissions in the last month of life by month and cause of death_
...
emadm_month <- read_csv(here::here("output", "os_reports", "eol_service", "emadm_month.csv")) %>%
  filter(study_month == max(read_csv(here::here("output", "os_reports", "eol_service", "emadm_month.csv"))$study_month)) %>%
  group_by(study_month,pod_ons_new) %>%
  summarise(mean = mean(emadm_month[pod_ons_new=Home]))
```

Emergency admissions towards the end of life are often not the best outcomes for patients. We previously reported that over the last three months of life, average emergency admissions per person during the pandemic were similar to pre-pandemic levels.{ _Figure 11_ and _Figure 12_ show this trend and how things have changed in the intervening period. In the most recent month (`r emadm_month %>% select(study_month) %>% slice(1) %>% pull`) there were an average of `r emadm_month %>% select(mean) %>% slice(1) %>% pull` emergency admissions per person recorded in OpenSAFELY-TPP for people who died at home.

### Place of death

_Figure 11: Average number of emergency admissions per person by month and place of death_
...
_Figure 12: Average number of emergency admissions in the last month of life by month and cause of death_
...
In our previous work we reported that people who died at home during the pandemic were as likely as people who died at home pre-pandemic to have community nursing team care coded in their GP record in the last month of life. _Figure 13_ and _Figure 14_ show this trend as well as subsequent changes. 

### Place of death

_Figure 13: Average number of community nursing contacts per person by month and place of death_
...
_Figure 14: Average number of community nursing contacts in the last month of life by month and cause of death_
