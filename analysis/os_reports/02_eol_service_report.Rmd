...
knitr::include_graphics(here::here("output", "os_reports", "eol_service", "eol_med_plot.png"))
```
...
_Figure 5: Average number of outpatient appointments per person by month and place of death_
